...
{
    /// <inheritdoc />
    public partial class systemHistory : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Gender = table.Column<byte>(type: "tinyint", nullable: false, defaultValue: (byte)0, comment: "0=Unknown, 1=Male, 2=Female, 3=Other, 4=PreferNotToSay"),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SystemHistories_Permissions_PermissionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SystemHistories_PermissionId",
